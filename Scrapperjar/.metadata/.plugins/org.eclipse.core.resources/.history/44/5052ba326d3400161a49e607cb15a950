...
public class MainRun
	...
	public static void Testconfig()
	{
		...
		String loopcount = GetData.fromProperties(".\\data\\config.properties", "loopcount");
		String loadingtime = GetData.fromProperties(".\\data\\config.properties", "loadingtime");
		...
		try {
			Thread.sleep(Integer.parseInt(loadingtime));
			String a=driver.getTitle();
			System.out.println(a);
			StoreData.toExcel(".\\data\\interCity_Distance_Time.xlsx", "Sheet1", i, 2, a);
			Thread.sleep(1000);
		} 
